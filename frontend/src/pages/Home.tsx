...
import BgHero from "../images/hero.png";
    ...
    >
      ...
      <div className="relative z-10 px-6 md:px-16 max-w-5xl">
        <h1 className="text-white font-bold text-4xl md:text-6xl leading-tight">
          ...
          Through ICT, Digital Skills & Innovation
        </h1>
        ...
        <div className="flex items-center gap-4 mt-10">
          <Link to="/services" className="bg-green-600 hover:bg-green-700 font-semibold text-white px-6 py-3 rounded-xl flex items-center gap-2">
